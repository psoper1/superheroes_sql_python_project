...
def open_main_menu():
    ...
    if main_menu == "1":
        ...
        new_name = str(input("Enter the name of the new hero:\n"))
        new_bio = str(input(f"Enter a bio for {new_name}\n"))
        query = f"INSERT INTO heroes (name, about_me, biography) VALUES ('%s', 'null', '%s')"
